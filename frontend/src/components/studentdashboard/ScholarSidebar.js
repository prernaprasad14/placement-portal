...
const  ScholarSidebar= ({menu,chosenItem}) => {
  ...
  return(  
    ...
    <>
      <div id="side-menu" >
          <Link to='#' onClick={()=>chosenItem("5")} className='side-menu-links'>
          ...
          <Link to='#profile' onClick={()=>chosenItem("0")} className='side-menu-links'>
            <div className='text-lg '>
          ...
          <Link to="#companies"  onClick={()=>chosenItem("1")} className='side-menu-links'>
            <div className='text-lg '>              
          ...
          <Link to='#notifications' onClick={()=>chosenItem("2")} className='side-menu-links'>
            <div className='text-lg '>              
