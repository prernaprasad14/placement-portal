    ...
    <footer className='bg-slate-800 text-center text-lg-start text-muted'>
        ...
        <div className='container  container-fluid text-center text-md-start mt-2'>
          <div className='row mt-1 py-3 px-5'>
            <div className='my-2 col-md-3 col-lg-3 col-xl-3 mx-auto mb-md-0'>
            ...
            <div className='my-2  col-md-3 col-lg-3 col-xl-3 mx-auto'>
            ...
            <div className='my-2 col-md-2 col-lg-2 col-xl-2 mx-auto max-h-[190px]'>
            ...
            <div className='my-2  col-md-2 col-lg-2 col-xl-2 mx-auto p-0 mb-2 '>
